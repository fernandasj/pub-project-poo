...
public class ComandaDao implements DaoGeneric <Comanda>{
    ...
    /**
    * @param c elemento com tipo Comanda que será salvo na lista. Antes de salvar 
    * a comanda, é verificado se ela já existe, comparando o id. Caso exista é 
    * retornado FALSE.
    ...
    */
    ...
    public boolean deletar(Comanda c){
     ...
     /**
    * @param id número do id da comanda que será buscado na lista. Antes de buscar,
    * é verificado se a comanda existe. Caso não exista é retornado NULL.
    ...
    * atualizar,é feita uma busca pelo id para encontrar a comanda que se deseja 
    * modificar. Caso a comanda não seja encontrada é retornado FALSE.
    ...
    */
    ...
    /**
     * @param status nome do status que se deseja agrupar as comandas. Para fazer
     * esse agrupamento/seleção/lista, é criada uma nova lista do tipo Comanda que
     * irá armazenar todas as comandas com o status desejado, selecionadas da lista
     * que contém todas as comandas do sistema.
